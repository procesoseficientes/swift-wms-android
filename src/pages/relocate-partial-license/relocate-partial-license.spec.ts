...
describe("RelocatePartialLicensePage Component", () => {
    // FIXME: Must split this controller with providers
    let fixture: any;
    let component: RelocatePartialLicensePage;

    beforeEach(
        async(() => {
            let navController = NavControllerMock.instance();
            let relocateParam: Model.RelocatePartialLicenseParams = <Model.RelocatePartialLicenseParams>{
                targetLicenseId: 480203,
                sourceLicenseId: 439466,
                policyCode: "503826",
                clientOwner: "ARIUM"
            };
            let navParams = NavParamsMock.instance();
            navParams.data = relocateParam;
            ...
            TestBed.configureTestingModule({
                declarations: [RelocatePartialLicensePage, TranslatePipeMock],
                imports: [
                    IonicModule.forRoot(RelocatePartialLicensePage)
                ],
                providers: [
                    {
    ...
    const loadComponent = () => {
        fixture = TestBed.createComponent(RelocatePartialLicensePage);
    ...
    it("Should be created", () => {
        return expect(component instanceof RelocatePartialLicensePage).toBe(
            true
        );
    });
    ...
    describe("Valid Tests", () => {
        ...
        it("Scanned material should exist and handle batch", () => {
            let execute = async () => {
                ...
                expect(result).toBeTruthy("ScanBarcode Result should be true.");
                expect(component.material.barcodeId).toBe(
                    "motorganica/VBW1101",
        ...
        it("Scanned material should exist and be a car", () => {
            let execute = async () => {
                ...
                expect(component.material.isCar).toBe(
                    Enums.YesNo.Yes,
    ...
    describe("Invalid Tests", () => {
        ...
        it("Scanned material doesn't belong to license", () => {
            let execute = async () => {
                component.currentScan = Enums.ReceptionScanner.Material;
                component.scanData = "NOTBELONGLICENSE";
                await component.processBarcodeScan(component.scanData);

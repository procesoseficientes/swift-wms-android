...
export class ProcessGeneralPickingSeriesPage {
    ...
    userWantsToAddSeriesRank(): Promise<void> {
        this.navParams.data.operationType = Enums.TaskType.GeneralDispatch;
    ...
    ionViewDidEnter(): void {
        ...
        if (
            this.navParams.data.quantity != null &&
        ...
        if (this.taskHeader.ScannedSeries != null) {
            this.taskHeader.ScannedSeries.forEach(serialEach => {
                ...
                if (!serialFind) {
                    if (this.material.quantity > 0) --this.material.quantity;

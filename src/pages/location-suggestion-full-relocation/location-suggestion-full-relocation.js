...
let LocationSuggestionFullRelocationPage = class LocationSuggestionFullRelocationPage {
    ...
    ionViewDidLoad() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                this.showLocationByZona = false;
                this.showLocationByMaterial = false;
                this.relocationFullParam = this
                    .navParams.data;
                switch (this.relocationFullParam.showSuggestedLocation) {
                ...
                this.relocationFullParam.comesFrom =
                    enums_1.Enums.Page.LocationSuggestionFullRelocation;
                if (this.showLocationByZona == false &&
                    this.showLocationByMaterial == false) {
                    this.navigationPage(enums_1.Enums.Page.RelocateFullLicense, this.relocationFullParam);
                }
                if (this.showLocationByZona == false &&
                    this.parameterSuggestionMaterial == 0) {
                    this.navigationPage(enums_1.Enums.Page.RelocateFullLicense, this.relocationFullParam);
    ...
    getLocationSuggestionToServer() {
        return __awaiter(this, void 0, void 0, function* () {
            let suggestedLocation = models_1.DataRequest.Factory.createSuggestedLocation(this.relocationFullParam.licenseId, this.settings.userCredentials);
    ...
    processLocationByZone(location) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.userInteraction.showLoading();
                this.relocationFullParam.locationScan = location;
                ...
                if (this.currentScan === enums_1.Enums.SuggestedLocationScan.LocationByZone) {
                    ...
                    if (this.listSuggestionZone &&
                        ...
                        yield this.listSuggestionZone.forEach((zone) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            this.relocationFullParam.location = location;
                            this.relocationFullParam.comesFrom =
                                enums_1.Enums.Page.LocationSuggestionFullRelocation;
                            switch (page) {
                                case enums_1.Enums.Page.RelocateFullLicense:
                                    this.navigation.pushPage(page, this.workspace, this.navCtrl, this.relocationFullParam);
                                    break;
                            }
                        }));
                    }
    ...
    validateLocation(location) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (validateResult.Resultado === enums_1.Enums.OperationResult.Success) {
                return Promise.resolve(enums_1.Enums.Page.RelocateFullLicense);
            }
            else {
                yield this.userInteraction.hideLoading();
    ...
    backButtonAction() {
        ...
        return this.navigation.popPage(this.workspace, this.navCtrl, this.relocationFullParam);
    }
};
LocationSuggestionFullRelocationPage = __decorate([
    ionic_angular_1.IonicPage(),
    core_1.Component({
        selector: "page-location-suggestion-full-relocation",
        templateUrl: "location-suggestion-full-relocation.html"
    }),
...
exports.LocationSuggestionFullRelocationPage = LocationSuggestionFullRelocationPage;
//# sourceMappingURL=location-suggestion-full-relocation.js.map
...
export class MaterialProvider {
    ...
    getMaterial(_request: DataRequest.GetMaterial): Promise<Model.Material> {
        if (_request.materialId === "ERROR") {
            return Promise.reject("Invalid operation");
        } else {
            let material = Model.Factory.createMaterial();
            material.materialId = _request.materialId || _request.barcodeId;
            return Promise.resolve(material);
        }
    }

    getMaterialByBarcode(_request: DataRequest.GetMaterial): Promise<Model.Material> {
        let material: Model.Material;
        if (_request.barcodeId === "BATCH") {
            material = {
        ...
        } else if (_request.barcodeId === "SERIAL") {
            material = {
        ...
        } else if (_request.barcodeId === "VIN") {
            material = {
        ...
        } else if (_request.barcodeId === "EMPTY") {
            material = {
        ...
        }else if (_request.barcodeId === "NOTBELONGLICENSE") {
            material = {
                materialId: "motorganica/VBW11311",
                clientOwner: "motorganica",
                barcodeId: "motorganica/VBW1132",
                alternateBarcode: "",
                materialName: "BALDWIN FILTRO PA3610",

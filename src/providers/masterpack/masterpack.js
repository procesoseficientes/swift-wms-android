...
let MasterpackProvider = class MasterpackProvider {
    constructor(api) {
        this.api = api;
    }
...
MasterpackProvider = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [api_client_v3_1.ApiClientV3Provider])
], MasterpackProvider);
exports.MasterpackProvider = MasterpackProvider;
//# sourceMappingURL=masterpack.js.map
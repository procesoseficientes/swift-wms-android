...
let GeneralTransferProvider = class GeneralTransferProvider {
    constructor(api) {
        this.api = api;
    }
...
GeneralTransferProvider = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [api_client_v3_1.ApiClientV3Provider])
], GeneralTransferProvider);
exports.GeneralTransferProvider = GeneralTransferProvider;
//# sourceMappingURL=general-transfer.js.map
...
(function (UnitTesting) {
    UnitTesting.getTestCredentials = () => {
        let credentials = models_1.Model.Factory.createUserCredentials();
        credentials.loginId = "BCORADO@L3W";
        credentials.password = "123";
        credentials.communicationAddress = "http://localhost:6661";
        return credentials;
    };
    UnitTesting.generalPickingSeriesTask = () => {
        return {
            id: 527480,
            wavePickingId: 4892,
            transOwner: 0,
            taskType: enums_1.Enums.TaskType.Picking,
            taskSubtype: enums_1.Enums.TaskSubType.GeneralDispatch,
            taskOwner: "ADMIN",
    ...
    UnitTesting.getDefaultTypeCharges = () => {
        return [
            {
                typeChargeId: 1029,
                charge: "AREA SECA",
...
})(UnitTesting = exports.UnitTesting || (exports.UnitTesting = {}));
//# sourceMappingURL=common.unit.js.map